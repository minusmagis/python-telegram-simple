...
from telegram_simple.client import Telegram, MESSAGE_HANDLER_TYPE, AuthorizationState
...
@pytest.fixture
def telegram():
    with patch('telegram_simple.client.TDJson'):
        with patch('telegram_simple.client.threading'):
    ...
    def test_set_initial_params(self, telegram):
        ...
        exp_data = {
            ...
            'parameters': {
                ...
                'api_id': API_ID,
                'api_hash': API_HASH,
                'device_model': 'python-telegram_simple',
