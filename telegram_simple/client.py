...
class Telegram:
    def __init__(
        ...
        device_model: str = 'python-telegram_simple',
    ...
    def stop(self) -> None:
        ...
        logger.info('Stopping telegram_simple client...')
    ...
    def login(self, blocking: bool = True) -> AuthorizationState:
        ...
        Returns:
         - AuthorizationState.WAIT_CODE if a telegram_simple code is required.
           The caller should ask the telegram_simple code
           to the end user then call send_code(code)
         - AuthorizationState.WAIT_PASSWORD if a telegram_simple password is required.
           The caller should ask the telegram_simple password
    ...
    def send_code(self, code: str) -> AuthorizationState:
        """
        Verifies a telegram_simple code and continues the authorization process
    ...
    def send_password(self, password: str) -> AuthorizationState:
        """
        Verifies a telegram_simple password and continues the authorization process
