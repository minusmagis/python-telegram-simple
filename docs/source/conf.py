...
project = 'python-telegram_simple'
...
html_theme_options = {
    ...
    'github_repo': 'python-telegram_simple',
    'github_button': True,
    'github_type': 'star',
    'extra_nav_links': {
        'Main page': '/',
...
latex_documents = [
    (master_doc, 'python-telegram_simple.tex', 'python-telegram_simple Documentation',
...
man_pages = [
    (master_doc, 'python-telegram_simple', 'python-telegram_simple Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python-telegram_simple', 'python-telegram_simple Documentation',
     author, 'python-telegram_simple', 'One line description of project.',
     'Miscellaneous'),
]
